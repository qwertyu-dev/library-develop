...
class TestExcelMappingInit:
    ...
    def test_init_C0_default_configuration(self):
        ...
        expected_layout = [
            'ulid', 'applicant_info', 'application_type', 'target_org',
            'business_unit_code', 'parent_branch_code', 'branch_code',
            'branch_name', 'section_gr_code', 'section_gr_name',
            'section_name_en', 'resident_branch_code', 'resident_branch_name',
            'aaa_transfer_date', 'internal_sales_dept_code',
    ...
    def test_init_C0_full_configuration(self):
        ...
        custom_config.package_config['layout'] = {
            'unified_layout': [
                ...
                'branch_code', 'branch_name', 'section_gr_code',
                'section_gr_name', 'section_name_en',
            ],
        }
