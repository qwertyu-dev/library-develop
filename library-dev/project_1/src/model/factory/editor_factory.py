...
class EditorFactory:
    ...
    def __init__(self, decision_table: pd.DataFrame, import_facade: str, editor_classes: dict[str, DataFrameEditor] | None=None):
        """イニシャライザー
        ...
        if 'DataFrameEditorDefault' not in self.decision_table['DecisionResult'].to_numpy():
